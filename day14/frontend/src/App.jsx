  ...
  return (
    <main className="app">
      <header className="masthead">
        <div>
          <h1>Инварианты и состояние задачи</h1>
          <p>
            Ассистент работает в рамках инвариантов: хранит их отдельно от
            диалога, учитывает в каждом ответе и отказывается от решений,
            которые их нарушают. Задача при этом идёт по конечному автомату
