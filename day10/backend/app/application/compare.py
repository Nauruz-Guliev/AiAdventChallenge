...
SCENARIO_HINT = " Ответь максимально коротко, один-два предложения."

SCENARIO_TURNS = [
    "Работаем над ТЗ внутреннего сервиса. Кодовое имя продукта — Буревестник."
    + SCENARIO_HINT,
    "Целевая аудитория — служба поддержки, 15 человек." + SCENARIO_HINT,
    "Бюджет проекта — 1200 человеко-дней, больше нельзя." + SCENARIO_HINT,
    "Жесткое ограничение: только on-prem, без внешнего облака." + SCENARIO_HINT,
    "Хранилище — PostgreSQL, ничего экзотического." + SCENARIO_HINT,
    "Срок сдачи — до 15 декабря." + SCENARIO_HINT,
    "Регулярный ритуал: отчёт по пятницам." + SCENARIO_HINT,
    "Интеграция только с внутренним helpdesk." + SCENARIO_HINT,
    "Интерфейс: тёмная тема и управление с клавиатуры." + SCENARIO_HINT,
    "Отчётность: экспорт в CSV и дашборд метрик." + SCENARIO_HINT,
]
